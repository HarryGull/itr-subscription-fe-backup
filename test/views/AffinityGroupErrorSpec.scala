...
class AffinityGroupErrorSpec extends UnitSpec with MockitoSugar with WithFakeApplication with FakeRequestHelper {

  val signInURL = "sign-in"
  val createAccountURL = "register"
  lazy val page = AffinityGroupError(signInURL, createAccountURL)(fakeRequest)
