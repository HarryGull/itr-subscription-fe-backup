  ...
  "Review Company Details page" when {
    ...
    "Passed details with every optional field filled in" should {
      ...
      "Display all optional fields on the page" in {
        ...
        document.body.getElementById("name").text shouldBe s"${maxContact.forename} ${maxContact.surname}"
        document.body.getElementById("telephonenumber").text shouldBe maxContact.telephoneNumber.get
        document.body.getElementById("mobilenumber").text shouldBe maxContact.mobileNumber.get
    ...
    "Passed details with no optional fields filled in" should {
      ...
      "Display no optional fields on the page" in {
        ...
        document.body.getElementById("name").text shouldBe s"${minContact.forename} ${minContact.surname}"
